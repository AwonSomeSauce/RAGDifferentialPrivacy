...
class Trainer:
    ...
    def train(self, train_loader, val_loader=None):
        ...
        if val_loader is not None:
            ...
            print(f"Init_val_acc: {init_val_acc:5f}")
    ...
    def evaluate(self, data_loader):
        ...
        for batch in tqdm(data_loader):
            ...
            with torch.no_grad():
                preds = self.model(
                    inputs_ids, token_type_ids=None, attention_mask=inputs_masks
                )
    ...
    def predict(self, data_loader):
        self.model.load_state_dict(torch.load(f'{"./trained_model"}/model.pkl'))
        self.model.eval()
        y_list = []
        y_hat_list = []
        for batch in tqdm(data_loader):
    ...
    def save_model(self):
        if not os.path.exists("./trained_model"):
            os.mkdir("./trained_model")
        torch.save(self.model.state_dict(), f'{"./trained_model"}/model.pkl')
